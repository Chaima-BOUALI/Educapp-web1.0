 ...
 * CompteRendu
 *
 * @ORM\Table(name="compte_rendu", indexes={@ORM\Index(name="IDX_D39E69D2613FECDF", columns={"session_id"}), @ORM\Index(name="IDX_D39E69D2A76ED395", columns={"user_id"}), @ORM\Index(name="IDX_D39E69D28D0EB82", columns={"candidat_id"})})
 * @ORM\Entity
 */
class CompteRendu
{
