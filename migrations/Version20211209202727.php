 ...
 */
final class Version20211209202727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidat (id INT AUTO_INCREMENT NOT NULL, session_id INT DEFAULT NULL, nom_candidat VARCHAR(255) NOT NULL, prenom_candidat VARCHAR(255) NOT NULL, email_candidat VARCHAR(255) NOT NULL, numero_telephone_candidat VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, date_de_naissance DATE NOT NULL, INDEX IDX_6AB5B471613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, nom_session VARCHAR(255) NOT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, description_session LONGTEXT NOT NULL, places_disponibles INT NOT NULL, url_image VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
