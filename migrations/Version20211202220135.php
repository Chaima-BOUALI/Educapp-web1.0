 ...
 */
final class Version20211202220135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, session_id INT DEFAULT NULL, user_id INT DEFAULT NULL, type_abonnement VARCHAR(255) NOT NULL, date_abonnement DATE NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_351268BBA76ED395 (user_id), INDEX IDX_351268BB613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE compte_rendu (id INT AUTO_INCREMENT NOT NULL, session_id INT DEFAULT NULL, candidat_id INT DEFAULT NULL, user_id INT DEFAULT NULL, non_compte_rendu VARCHAR(255) NOT NULL, date_limite DATE NOT NULL, INDEX IDX_D39E69D2613FECDF (session_id), INDEX IDX_D39E69D28D0EB82 (candidat_id), INDEX IDX_D39E69D2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE demande_enseignement (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nom_demande VARCHAR(255) NOT NULL, description_demande LONGTEXT NOT NULL, decision TINYINT(1) NOT NULL, url_participation VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_5C1A82B6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, session_id INT DEFAULT NULL, nom_promotion VARCHAR(255) NOT NULL, pourcentage VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C11D7DD1613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publicity (id INT AUTO_INCREMENT NOT NULL, session_id INT DEFAULT NULL, nom_publicity VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, description_pub LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, INDEX IDX_9381276613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nom_reclamation VARCHAR(255) NOT NULL, etat_reclamation VARCHAR(255) NOT NULL, contenu_reclamation LONGTEXT NOT NULL, date_reclamation DATE NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_CE606404A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, nom_session VARCHAR(255) NOT NULL, end_date DATE NOT NULL, description_session LONGTEXT NOT NULL, places_disponibles INT NOT NULL, url_image VARCHAR(255) NOT NULL, start_date DATE NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
