 ...
 */
final class Version20211202035242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, session_id INT DEFAULT NULL, user_id INT DEFAULT NULL, type_abonnement VARCHAR(255) NOT NULL, date_abonnement DATE DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_351268BBA76ED395 (user_id), INDEX IDX_351268BB613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE promotion (id INT AUTO_INCREMENT NOT NULL, session_id INT DEFAULT NULL, nom_promotion VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C11D7DD1613FECDF (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, nom_session VARCHAR(255) NOT NULL, start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, description_session LONGTEXT DEFAULT NULL, places_disponibles INT DEFAULT NULL, url_image VARCHAR(255) DEFAULT NULL, categorie_session VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
